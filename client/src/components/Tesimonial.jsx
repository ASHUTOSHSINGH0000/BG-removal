...
const Tesimonial = () => {
  return (
    <div>
        <h1 className=" mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl font-semibold mb-6 py-5"> Customer  <span className='text-blue-600'>Testimonials</span>  </h1> 
